using Battle_Management_System.Decisive_Coin_System.Data;
using Battle_Management_System.Decisive_Coin_System.Object;
using Battle_Management_System.Decisive_Coin_System.State_Machine;
using Battle_Management_System.Decisive_Coin_System.State_Type;
using DG.Tweening;
using UnityEngine;

namespace Battle_Management_System.Decisive_Coin_System
{
