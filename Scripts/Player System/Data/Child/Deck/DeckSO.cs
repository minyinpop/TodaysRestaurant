...
namespace Player_System.Data.Child.Deck
{
    [CreateAssetMenu(menuName = "Minyinpop/Player/Child/Deck Data", fileName = "New Data")]
    internal sealed class DeckSO : ScriptableObject
    {
