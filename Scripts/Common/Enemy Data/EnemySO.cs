...
namespace Common.Enemy_Data
{
    ...
    public sealed class EnemySO : ScriptableObject
    {
        ...
        [field: Header("敵人的預製件")]
        [field: SerializeField] private EnemyExploreObject enemyExploreObject;
                                public EnemyExploreObject EnemyExploreObject => enemyExploreObject;
