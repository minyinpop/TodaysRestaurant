...
namespace Common.Enemy_Battle_Object.Main
{
    ...
    public abstract class BattleEnemyObject : MonoBehaviour
    {
        ...
        [field: SerializeField] protected Transform SFXParent;
        ...
        public abstract void Attack(Action haveCharacterAlive, Action characterAllDead, Action onAttackSpineComplete);
