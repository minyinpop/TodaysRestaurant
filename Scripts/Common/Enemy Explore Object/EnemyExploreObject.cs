...
using Common.Enemy_Explore_Object.State_Machine;
using Common.Enemy_Explore_Object.State_Machine.State;
using UnityEngine;
using UnityEngine.AI;

namespace Common.Enemy_Explore_Object
{
    public partial class EnemyExploreObject : MonoBehaviour
    {
        ...
        public static event Action<EnemyExploreObject, EnemyBattleGroupSO> OnAttack;
