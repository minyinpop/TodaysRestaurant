...
using System.Restaurant.Child.Cook_Menu.Object;
using System.Restaurant.Child.Cook_Menu.System.Child.Open_UI_System.Child;
...
using Data.Restaurant;
using Data.Restaurant.Cook_Menu;
using Data.Restaurant.Cook_Menu.Select_Food_Page;
using UnityEngine;

namespace System.Restaurant.Child.Cook_Menu.System.Child.Open_UI_System.Main
{
        ...
        public void Show()
        {
            ...
            foreach (var category in dishCategory)
            {
                ...
                void OnClicked(FoodType foodType)
                {
                    ...
                    SelectFoodPageData.Get(out var itemsData);
